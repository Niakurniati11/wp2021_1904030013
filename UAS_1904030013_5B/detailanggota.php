    ...
    <section class="jumlah">
      <div class="container">
        ...
        <ul class="list-group">
          ...
          <li class="list-group-item">No Hp : <?= $camaba['no_hp']; ?></li>

          <li class="list-group-item">
            <a href="editang.php?id=<?= $camaba['id'];  ?>" class="btn btn-warning" role="button">edit</a> |
            <a href="hapusang.php?id=<?= $camaba['id'];  ?>" onclick="return confirm('apakah anda akan menghapus data ini');" class="btn btn-danger" role="button">hapus</a> |
